...
func init() {
	...
	types.RegisterSignature(types.CompressSig{
		Name: "lzbluesky", WordAligned: true,
		Sig: []byte{
			0x18, 0x1B, 0xE7, 0x4C, 0x1A, 0x03, 0xE8, 0x0D, 0x02, 0x45, 0x00, 0x07, 0x88, 0x05, 0x02, 0x44, 0x07, 0xFF, 0x02, 0x43, 0x00, 0x0F, 0x54, 0x43, 0x44, 0x44, 0xD8, 0x46, 0x02, 0x44, 0x07, 0xFF,
		},
	})
