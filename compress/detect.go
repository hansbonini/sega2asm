...
var signatures = []struct {
	...
	},
	{
		...
		"lzclimax3",
		[]byte{0x74, 0x1F, 0xC4, 0x41, 0x92, 0x42, 0x0C, 0x41, 0x00, 0x20},
	},
	{
		// Powerpack 2.0 — used in James Pond 3 and other Amiga-ported titles. No magic bytes, so we look for the distinctive bitstream reader loop near the end of the decompressor routine.
		"powerpack20",
		[]byte{0x5C, 0x54, 0xE2, 0xAD, 0xE0, 0x89, 0xD7, 0xC1, 0x2A, 0x41, 0x61, 0x1E},
	},
	{
		// LZ Bahamut — Bahamut Senki byteplane font/tile decompressor (sub_CD8)
