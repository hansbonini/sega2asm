...
var signatures = []signature{
	...
	{
		// LZSS Koei — used in Koei's Romance of the Three Kingdoms and Nobunaga's Ambition series.
		name:        "lzsskoei",
		wordAligned: true,
		sig: []byte{
	...
	{
		// Huffman Sloane — Burt Sloane's nibble-packed Huffman tile decompressor.
		// Detected via the two ROM data tables used by the decompressor:
		//   dword_3F75C: nibble fill patterns 0x11111111..0xFFFFFFFF (colors 1-15)
		//   dword_3F79C: cumulative nibble masks 0x0000000F..0xFFFFFFFF
		// These 96 bytes (60 fill + 36 mask) are always contiguous in ROM.
		name:        "huffsloane",
		wordAligned: false,
		sig: []byte{
			// Fill patterns (colors 1-15, color 0 = 0x00000000 is before this)
			...
			// Cumulative nibble masks (0 through 8 nibbles)
			0x00, 0x00, 0x00, 0x00,
